...
use JCB\Joomla\Helloworld\Table as DataTable;
use JCB\Joomla\Helloworld\Table\Schema;
use JCB\Joomla\Helloworld\Table\Validator;
...
/***[JCBGUI.power.main_class_code.762.$$$$]***/
	...
	/**
	 * Get The Helloworld Data Table Class.
	 *
	 * @param   Container  $container  The DI container.
	 *
	 * @return  DataTable
