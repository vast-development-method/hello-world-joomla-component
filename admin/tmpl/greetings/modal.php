...
/** @var \JCB\Component\Helloworld\Administrator\View\Greetings\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_helloworld&view=greetings&layout=modal&tmpl=component&titleKey=' . $this->getModalTitleKey()); ?>" method="post" name="adminForm" id="adminForm">
	<div id="j-main-container">
<?php
	// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 8505] Add the trash helper layout
	echo LayoutHelper::render('trashhelper', $this);
	// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 8511] Add the searchtools
