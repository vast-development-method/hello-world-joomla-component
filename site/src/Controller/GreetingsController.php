...
// The class header for site views controller. Only use this option if you have a getListQuery as your Main Get, and have custom code in the PHP (controller methods) under the Custom Buttons tab.

// No direct access to this file
\defined('_JEXEC') or die;

/**
 * Helloworld Greetings Form Controller
 *
 * @since  1.6
 */
...
/***[JCBGUI.site_view.php_controller.85.$$$$]***/
