...
/------------------------------------------------------------------------------------------------------*/
namespace JCB\Component\Helloworld\Site\View\Greet;
...
// The class header header for site view. Only use this option if you have a getItem as your Main Get.

// No direct access to this file
\defined('_JEXEC') or die;

/**
 * Helloworld Html View class for the Greet
 *
 * @since  1.6
 */
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null): void
	{
		...
		$this->canDo = Actions::get('greet');

		// Load module values
		$model = $this->getModel();
		$this->styles = $model->getStyles() ?? [];
		$this->scripts = $model->getScripts() ?? [];
		// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 2091] Initialise variables.
		$this->item = $model->getItem();
		
		/***[JCBGUI.site_view.php_jview_display.84.$$$$]***/
...
/***[JCBGUI.site_view.view_toolbar.84.$$$$]***/
// Provide PHP code to be executed in the addToolbar() method of the Site_view HtmlView. When defined, this code completely overrides JCB default toolbar buttons./***[/JCBGUI$$$$]***/
	...
	protected function _prepareDocument(): void
	{
		...
		Html::_('script', 'components/com_helloworld/assets/js/greet.js', ['version' => 'auto']);
		// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 2854] load the meta description
		...
		// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 2868] load the key words if set
		...
		// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 2883] check the robot params
		...
		// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 2897] check if autor is to be set
		if (isset($this->item->created_by) && $this->params->get('MetaAuthor') == '1')
		{
			$this->getDocument()->setMetaData('author', $this->item->created_by);
		}
		// [VDM\Joomla\Componentbuilder\Compiler\Helper\Interpretation 2906] check if metadata is available
		...
		/***[JCBGUI.site_view.php_document.84.$$$$]***/
		...
		$this->getDocument()->getWebAssetManager()->addInlineScript("
			...
			/***[JCBGUI.site_view.js_document.84.$$$$]***/
